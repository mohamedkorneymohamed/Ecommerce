...
<div className="col-md-4">
    <Slider {...settings}>
{productDetails?.images.map((img , index )=><img key={index} className='w-100' src={img}/>)}
    </Slider>
        </div>
...
<div className="d-flex justify-content-between p-2 ">
  ...
  <button onClick={()=>addProduct(productDetails.subcategory._id)} className='btn bg-main text-white w-100'>+ Add</button>
